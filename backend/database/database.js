...
const insertInitialData = async () => {
    try {
        // Inserir categorias
        const categories = [
            ['Pizza', 'As melhores pizzas da cidade', 'Pizzas artesanais feitas com ingredientes selecionados', 'pizza.jpg'],
            ['Hambúrguer', 'Hambúrgueres gourmet', 'Carnes selecionadas e pães artesanais', 'burger.jpg'],
            ['Japonesa', 'Culinária japonesa autêntica', 'Sushis, sashimis e pratos quentes', 'japanese.jpg']
        ];
        ...
        // Inserir produtos
        const products = [
            ['Pizza Margherita', 'Molho de tomate, mussarela, tomate e manjericão', 'Pizza tradicional italiana', 'margherita.jpg', 49.90, 1, 1],
            ['Pizza Pepperoni', 'Molho de tomate, mussarela e pepperoni', 'Pizza com pepperoni importado', 'pepperoni.jpg', 59.90, 1, 1],
            ['X-Burger', 'Hambúrguer artesanal, queijo, alface, tomate e molho especial', 'Hambúrguer gourmet', 'xburger.jpg', 29.90, 2, 2],
            ['X-Bacon', 'Hambúrguer artesanal, queijo, bacon, alface, tomate e molho especial', 'Hambúrguer com bacon', 'xbacon.jpg', 34.90, 2, 2],
            ['Combo Sushi', '12 peças de sushi variado', 'Mix de sushis', 'combo_sushi.jpg', 89.90, 3, 3],
            ['Temaki', 'Temaki de salmão com cream cheese', 'Temaki especial', 'temaki.jpg', 39.90, 3, 3],
            ['Pizza Frango', 'Molho de tomate, mussarela, frango e catupiry', 'Pizza de frango com catupiry', 'frango.jpg', 54.90, 1, 1],
            ['X-Tudo', 'Hambúrguer artesanal, queijo, bacon, ovo, presunto, alface, tomate e molho especial', 'Hambúrguer completo', 'xtudo.jpg', 39.90, 2, 2],
            ['Combo Hot Roll', '8 peças de hot roll', 'Hot roll com cream cheese', 'hot_roll.jpg', 49.90, 3, 3],
            ['Pizza Quatro Queijos', 'Molho de tomate, mussarela, parmesão, gorgonzola e catupiry', 'Pizza quatro queijos', 'quatro_queijos.jpg', 64.90, 1, 1]
        ];
